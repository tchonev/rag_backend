1. Download PDFs from https://isi-ml-public.s3.us-east-1.amazonaws.com/domaindata.zip and extract them into ~/Downloads/domaindata or another folder if you prefer so
